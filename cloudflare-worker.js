...
const productImageOverrides = {
  'DZ-CP01': 'images/products/iron-x-univerzalno-cistilno-sredstvo.jpg',
  'DZ-CP03': 'images/products/bilberry-wheel-cleaner-5l.avif',
...
const normalizeProduct = (product, categories = DEFAULT_CATEGORIES) => {
  ...
  const trustedImage = image.startsWith('images/products/') ? image : '';
  ...
  const stockStatus = product.stockStatus === 'out_of_stock'
    ...
    : legacyAvailability.includes('ni na zalogi') || legacyAvailability.includes('ni dobavljivo')
      ...
      : 'supplier';
  const stockCopy = {
    supplier: { availability: 'Na zalogi', delivery: 'Po potrditvi dobavitelja' },
    out_of_stock: { availability: 'Ni na zalogi', delivery: 'Dobavni rok trenutno ni znan' },
  }[stockStatus];
  ...
  return {
    ...
    image: trustedImage || imageOverride || '',
