...
- The admin catalog shows every bundled and KV-only product. The admin tracks only **Na zalogi** or **Ni na zalogi**, without maintaining stock quantities. Changes are stored in the Products KV namespace and the Worker blocks unavailable products during Checkout.
