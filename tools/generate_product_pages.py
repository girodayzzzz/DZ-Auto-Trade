...
DESCRIPTION_HEADING = re.compile(
    r"(?:^|\n)\s*(Navodila za uporabo|Varnostni napotki|Prednosti|Tehnični podatki|Tehnične karakteristike|Lastnosti|Uporaba|Uporabnost|Tovarniške odobritve in združljivost|Zaključek|Razvrstitev nevarnosti po zakonu o kemikalijah|Komplet vključuje|Vsebina kompleta|Montaža sistema|Redčenje|Mešalno razmerje|Napredna viskoznost 5W-30|Low-SAPS tehnologija|Primerno za LongLife intervale|Za katera vozila je primerno|Originalna embalaža in praktičnost|Ključne specifikacije):\s*",
    re.IGNORECASE,
)
